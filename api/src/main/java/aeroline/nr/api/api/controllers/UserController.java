...
public class UserController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<UserCreateDto>findById(@PathVariable("id") Integer id){
         UserCreateDto user= userService.findById(id)
         .map(t -> userMapper.toUserCreateDto(t))
    ...
    public ResponseEntity<List<UserCreateDto>> findAll(){
        ...
        List<UserCreateDto> userCreateDtos = users.stream()
                                             .map(t -> userMapper.toUserCreateDto(t))
